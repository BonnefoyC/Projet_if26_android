...
public class Logement {
    ...
    public static ArrayList<Logement> getInitialLogements() {
        ...
        liste.add(new Logement("Grand T2", "Particulier loue grand T2 dans résidence sécurisée avec vue sur le quai.\nPlein centre de Troyes et proche de toutes commoditées.", 520, 2, "Troyes", "Quai de Dampierre", 48.300852, 4.074747, "uri", "3"));
        liste.add(new Logement("Apt 70m2 résidence standing", "A louer appartement T3 rénové, en rez de chaussée surélevé de 70m2, très lumineux, sans vis-à-vis, dans une résidence standing avec gardien.", 465, 2, "Troyes", "26 rue du général leclerc", 48.299146, 4.077627, "uri", "4"));
        liste.add(new Logement("Belle grange centre ville", "Belle grange d'une surface de 175 m² proche centre ville des Noes près Troyes située rue Alexandre Lecorché.", 425, 1, "Troyes", "rue Alexandre Lecorché", 48.298682, 4.065992, "uri", "5"));
        liste.add(new Logement("Beau T1 + garage", "Loue appartement T1\nDans résidence de standing\nAvec parking privatif, portail, digicode, et ascenseur.", 425, 1, "Troyes", "42 rue de la cité", 48.299146, 4.077627, "uri", "6"));
        liste.add(new Logement("Spacieux Studio + garage", "Loue studio spacieux et lumineux à deux pas du centre ville.\nDeux grandes placards.\nCuisine équipée, salle de bain avec sèche serviette, digicode, et WC séparé.", 400, 1, "Troyes", "4 Rue Brunneval", 48.280408, 4.080018, "uri", "7"));
        liste.add(new Logement("Beau studio", "Studio meublé de 28 m² dans construction neuve, proche centre-ville, proche arrêt de bus.\nCuisine équipée (four, plaque de cuisson, table, chaises, placard penderie\nDisponible toute de suite.", 460, 1, "Troyes", "12 Rue Godard Pillaveine ", 48.278347, 4.078822, "uri", "8"));
        liste.add(new Logement("Superbe F2 ", "Belle pièce à vivre avec 2 doubles fenêtres, Cuisine ouverte aménagée avec plaques électriques, proche arrêt de bus.\nréfrigérateur, lave-vaisselle, éléments de rangements.\nLibre au 31/01/2018.", 450, 2, "Troyes", "22 rue Georges Clemenceau ", 48.2777806, 4.081190, "uri", "9"));
